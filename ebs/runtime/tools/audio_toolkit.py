...
class AudioToolkit(AsyncBaseToolkit):
    def __init__(self, config: ToolkitConfig = None) -> None:
        ...
        self.audio_client = SimplifiedAsyncOpenAI(
            api_key=EnvUtils.get_env("EBS_AUDIO_LLM_API_KEY"),  # NOTE: you should set these envs in .env
            base_url=EnvUtils.get_env("EBS_AUDIO_LLM_BASE_URL"),
        )
        self.audio_model = EnvUtils.get_env("EBS_AUDIO_LLM_MODEL")
