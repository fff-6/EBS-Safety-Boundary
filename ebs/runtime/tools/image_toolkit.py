...
class ImageToolkit(AsyncBaseToolkit):
    def __init__(self, config: ToolkitConfig = None) -> None:
        ...
        image_llm_config = {
            "type": EnvUtils.get_env("EBS_IMAGE_LLM_TYPE", "chat.completions"),
            "model": EnvUtils.get_env("EBS_IMAGE_LLM_MODEL"),  # NOTE: you should set these envs in .env
            "api_key": EnvUtils.get_env("EBS_IMAGE_LLM_API_KEY"),
            "base_url": EnvUtils.get_env("EBS_IMAGE_LLM_BASE_URL"),
        }
