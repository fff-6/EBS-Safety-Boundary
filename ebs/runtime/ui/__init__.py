...
class ExampleConfig:
    def __init__(self):
        self.example_query = ""
        self.ip = EnvUtils.get_env("EBS_WEBUI_IP", "127.0.0.1")
        self.port = EnvUtils.get_env("EBS_WEBUI_PORT", "8848")
        self.autoload = EnvUtils.get_env("EBS_WEBUI_AUTOLOAD", "false") == "true"
