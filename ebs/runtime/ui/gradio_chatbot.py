...
from ebs.runtime.agents import OrchestraAgent, SimpleAgent
...
class GradioChatbot:
    def __init__(self, agent: SimpleAgent | OrchestraAgent, example_query=""):
        ...
        with gr.Blocks(theme=gr.themes.Soft()) as demo:
            gr.Markdown("# EBS Agent Gradio Demo")
            with gr.Row():
            ...
            gr.Markdown("This is a simple agent demo using the EBS runtime.")
